(function () {
  ...
  var DICT = {
    ru: {
      ...
      "rev.title": "Отзывы",
      "rev.lead": "Имя, город и несколько слов о Tune — отзыв появится на этой странице.",
      "rev.name": "Имя",
      "rev.city": "Город",
      "rev.text": "Отзыв",
    ...
    en: {
      ...
      "nav.reps": "Dealers",
      "rev.title": "Reviews",
      "rev.lead": "Name, city and a few words about Tune — your review will appear on this page.",
      "rev.name": "Name",
      "rev.city": "City",
      "rev.text": "Review",
    ...
    ar: {
      ...
      "nav.reps": "الممثلون",
      "rev.title": "التقييمات",
      "rev.lead": "الاسم والمدينة وكلمات عن Tune — سيظهر التقييم في هذه الصفحة.",
      "rev.name": "الاسم",
      "rev.city": "المدينة",
      "rev.text": "التقييم",
    ...
    zh: {
      ...
      "nav.reps": "代理",
      "rev.title": "评价",
      "rev.lead": "姓名、城市和对 Tune 的几句话——评价会显示在本页。",
      "rev.name": "姓名",
      "rev.city": "城市",
      "rev.text": "评价",
      "rev.name_ph": "怎么称呼您",
